...
<asp:Content runat="server" ContentPlaceHolderID="mainPlaceHolder">
    ...
    <div class="form-group">
        ...
        <asp:Label ID="Label4" runat="server" Font-Bold="True" Text="Price per day: $"></asp:Label>
            ...
            <div class="form-group">
                ...
                <div>
                    <asp:RequiredFieldValidator ID="rfvArrivalDate" runat="server"
                        ControlToValidate="txtArrivalDate" Text="Please enter a valid date." CssClass="text-danger" Display="Dynamic" ErrorMessage="Please enter a message.">
                    </asp:RequiredFieldValidator>
                    <asp:CompareValidator ID="cvArrivalDate" runat="server" Text="Must be a valid date." CssClass="text-danger"
                        Display="Dynamic" ControlToValidate="txtArrivalDate" Type="Date" Operator="DataTypeCheck" ErrorMessage="Please enter a valid date."></asp:CompareValidator>
                </div>
    <br />
            <div class="form-group">
                ...
                <div">
                    <asp:RequiredFieldValidator ID="rfvDepartureDate" runat="server"
                        ControlToValidate="txtDepartureDate" Text="Please enter a valid date." CssClass="text-danger" Display="Dynamic" ErrorMessage="Please enter a valid date.">
                    </asp:RequiredFieldValidator>
